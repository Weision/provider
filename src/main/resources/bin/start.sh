...
VGS_CONST_OPTS=" -Dfile.encoding=UTF-8 "
VGS_DYNAMIC_OPTS=" -Dvgs.instanceNo=01 "
...
nohup java $JAVA_OPTS $VGS_CONST_OPTS $VGS_DYNAMIC_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$CLASSES_DIR:$LIB_JARS com.alibaba.dubbo.container.Main > $STDOUT_FILE 2>&1 &
